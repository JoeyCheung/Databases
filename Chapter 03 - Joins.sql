...
-- Displays everything in the two tables --
...
FROM HR.Employees AS E
  INNER JOIN Sales.Orders AS O
    ON E.empid = O.empid;
-- combining the columns that the two tables have in common --
...
FROM Sales.Customers AS C
 ...
 -- combining multiple tables that have common columns --
...
FROM Sales.Customers AS C
  LEFT OUTER JOIN Sales.Orders AS O
    ON C.custid = O.custid;
-- joins the two tables together whille keeping the columns from Sales.Customers table --
...
WHERE O.orderid IS NULL;
 -- joining the two tables together while keeping the columns from left table which is Sales.Customers and where Sales.Orders O.orderid is NULL --
...
WHERE O.orderdate >= '20160101';
 -- joining the two tables while keeping the table on the left and where O.orderdate has dates >= '20160101' --
